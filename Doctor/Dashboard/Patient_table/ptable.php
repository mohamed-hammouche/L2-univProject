...
$sql = "SELECT id, name, family_name, dtn, email FROM Patient";
...
<head>
    ...
    <link rel="stylesheet" href="ptable.css">
</head>
<body>
    <nav>
        ...
        <details>
            ...
            <ul>
                ...
                <li id="vpat">View All Patients</li>
            </ul>
        </details>
        <details>
    ...
    <div id="body">
        ...
        <table>
            ...
            <tr>
                ...
                <td><a href="More.php?id=<?php echo $row['id']; ?>">More</a></td>
                <td><a href="../../../creation/delete.php?id=<?php echo $row['id']; ?>&email=<?php echo urlencode($row['email']); ?>">Delete</a></td>            </tr>
            <?php endwhile; ?>
        </table>
    </div>
</body>
